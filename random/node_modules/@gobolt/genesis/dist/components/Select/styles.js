...
`, f = ({ colors: n, sizing: e, typography: o, borderRadius: t }, i, p, m) => {
  var s, l, c, d;
  return m === "simple" ? ((r, b, h, u) => `
    &.ant-select {
      ...
      .ant-select-selector {
        background-color: ${r.surface.secondary};
        border-color: ${r.surface.secondary};
        border-radius: ${u.BorderRadiusSm}px;
        margin: 0px;  
      }
    }
  `)(n, 0, 0, t) : `
    &.ant-select {
      ...
      //background-color:  ${n[i][p].backgroundColor}
...
`, w = a(g)`
  ${({ theme: n, type: e = "primary", state: o = "active", $variant: t = "none" }) => f(n, e, o, t)}
`;
export {
  w as Select,
  k as SelectDropdown,
